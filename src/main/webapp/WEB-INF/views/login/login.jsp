    ...
    <div class="loginContainer">
        ...
        <form id="loginForm" action="/gather/loginDo.com" method="post">
            ...
            <div class="socialButtons">
                ...
                <button class="kakaoLogin"><img src="path/to/kakao-icon.png" alt="Kakao Icon"> 카카오아이디 로그인</button>
                <button class="googleLogin"><img src="path/to/google-icon.png" alt="Google Icon"> 구글아이디 로그인</button>
            </div>
        </form>
